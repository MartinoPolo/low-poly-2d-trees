...
- [x] **REQ-EV2-Z-01** Classify branches as **front** (in front of trunk) or **back**
...
- [x] **REQ-EV2-BC-03** **Key visual requirement:** branches go into the **middle** of their
...
- [x] **REQ-EV2-BS-02** `canopySize` slider scales the **canopy envelope** smartly: - Adapts cluster boundaries so branches remain visible. - Small `canopySize` -> tight envelope, fewer tips covered, more bare branches visible
...
- [x] **REQ-EV2-CE-03** The canopy envelope grows freely with `canopySize`. SVG overflow clipping
...
- [x] **REQ-EV2-SS-03** Some branch tips naturally lack blobs — those that fall outside
